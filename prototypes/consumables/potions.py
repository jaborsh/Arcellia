HEALING_POTION = {
    ...
    "senses": {
        ...
        "smell": "A delicate aroma hints at alchemical gardens, where healers' knowledge has been distilled into the very breath of recuperation.",
        "sound": "The pop of the vial's seal crescendos into the quiet symphony of healing, an undercurrent to the respite contained within.",
        "taste": "The potion crosses the lips with the taste of fresh spring water, imbued with an essence both sweet and invigorating, a herald of rejuvenation.",
    },
    "weight": 0.2,
    "price": 10,
}
