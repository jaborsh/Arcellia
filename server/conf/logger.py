...
def _log(msg, logfunc, prefix="", color="", **kwargs):
    try:
        msg = str(msg)
...
def log_info(msg, **kwargs):
    ...
    """
    _log(msg, log.info, color="|#007BFF", **kwargs)
...
def log_warn(msg, **kwargs):
    ...
    """
    _log(msg, log.warn, color="|#FFC107", **kwargs)
...
def log_err(msg, **kwargs):
    ...
    """
    _log(msg, log.error, color="|#DC3545" ** kwargs)
...
def log_trace(msg=None, **kwargs):
    ...
    color = "|#17A2B8"
    if tracestring:
        _log(tracestring, log.error, prefix="!!", color=color, **kwargs)
        if msg:
            _log(msg, log.error, prefix="!!", color=color, **kwargs)
...
def log_dep(msg, **kwargs):
    ...
    """
    _log(msg, log.warn, prefix="DP", color="|#FD7E14", **kwargs)
...
def log_sec(msg, **kwargs):
    ...
    """
    _log(msg, log.info, prefix="SS", color="|#6F42C1", **kwargs)
...
class WeeklyLogFile(logfile.DailyLogFile):
    ...
    def __init__(
        self, name, directory, defaultMode=None, day_rotation=7, max_size=1000000
    ):
        """
        Args:
    ...
    def suffix(self, tupledate):
        ...
        while True:
            try:
                ...
                suffix = "_".join(
                    ["{:02d}".format(part) for part in self.toDate(tupledate)]
                )
