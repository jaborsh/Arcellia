...
PROTOTYPES_FLOOR0 = {
    (2, 0): {
        ...
        "smell": "A fresh, bracing scent of cold stone mingles with the earthy fragrance of the surrounding forests and meadows.",
        "sound": "The distant clang of the blacksmith, the rustling of leaves in the gentle breeze, and the occasional call of a bird of prey from the high battlements.",
        "taste": "A hint of the morning dew, or perhaps the kiss of an evening frost, imparts a crisp, clean taste to the air, as if drawing from the very essence of the land.",
        "details": {"walls": "The walls are made of stone."},
    },
    (2, 1): {
        ...
        "smell": "The rich scent of aging wood mingles with the faint aroma of beeswax from the candles and the occasional waft of lavender from the linens. ",
        "sound": "The hall echoes with the soft patter of footsteps on stone, the occasional creak of the timbers above, and the distant melody of a lute string plucked in a far-off corridor. ",
        "taste": "The air carries the subtle flavor of almond and honey from the kitchens, whetting the appetite for a feast that seems ever impending.",
    },
    (2, 2): {
        "key": "Castle Valaria - Grand Hall",
        "desc": "A great hall stretches magisterially from end to end, its lofty ceilings supported by robust columns that reach towards the heavens like the trunks of ancient trees. Vibrant banners drape from the vaulted expanse, each one a tapestry of heraldry that flutters gently, whispering tales of valor and legacy. Sentinel-like statues flank the peripheries, masterfully carved from marble and alabaster, their stoic faces and muscular forms embodying the virtues and triumphs of yesteryear. High above, an ornate balcony, wrought in intricate ironwork, graces the perimeter, offering a commanding view of the grandeur below. Its balustrade is a lacework of elegance, under which the multitude of faces revel in feasts and festivities, enveloped in the soft glow of torchlight. <morning>|/|/    Golden beams of the morning sun filter through the lancet windows, casting a radiant dance of light and shadow that plays across the floor in a mosaic of the day's nascent promise.</morning><afternoon>|/|/    The afternoon light spills across the high windows, bathing the great hall in a warm, amber radiance that illuminates the banners and breathes life into the statues as if they might descend and join the throng.</afternoon><evening>|/|/    The tender gleam of the evening moon filters in, casting a silvered hush over the hall, lending an ethereal quality to the faces of the statues and the fabric of the banners.</evening><night>|/|/    Suspended above, chandeliers gleam like constellations, their flickering candlelight reflecting off polished surfaces, mirroring the distant stars that peek through the night's veil from outside the high windows.</night>",
    ...
    (3, 2): {
        ...
        "smell": "The scent of beeswax and polished wood is dominant, with a faint whisper of dried lavender from the sachets secreted amongst the tapestries. ",
        "sound": "The hush is occasionally broken by the distant sound of a page turning, a sigh from an unseen servant, or the soft echo of a solitary set of footsteps pacing with contemplative regularity.",
        "taste": "In the stillness, there lies a taste of dust mingling with a ghost of incense long burned away, the flavor of the past lingering on the edge of perception.",
    },
    (3, 3): {
        ...
        "smell": "The scent of beeswax and polished wood is dominant, with a faint whisper of dried lavender from the sachets secreted amongst the tapestries. ",
        "sound": "The hush is occasionally broken by the distant sound of a page turning, a sigh from a servant, or the soft echo of a solitary set of footsteps pacing with contemplative regularity.",
        "taste": "In the stillness, there lies a taste of dust mingling with a ghost of incense long burned away, the flavor of the past lingering on the edge of perception.",
    },
    (4, 3): {
        ...
        "smell": "The space is heavy with the scent of oiled metal and worn leather, the pungent trademarks of diligent maintenance and storied use.",
        "sound": "The hushed room echoes with the near-silent clinks and clanks of weapons shifting, a constant reminder of the ready arsenal at hand.",
        "taste": "There is a tang of iron on the tongue, a metallic reminder of the armory's purpose and the bitter tang of conflict it embodies.",
    },
    (1, 2): {
    ...
    (1, 3): {
        ...
        "smell": "The aroma of roasted meats, freshly baked bread, and the piquant scent of spiced wine intermingle, creating an olfactory symphony that entices one's deepest cravings.",
        "sound": "A chorus of clinking silverware, the gentle murmur of conversation, and shared laughter create a lively acoustic tapestry that breathes life into the stony keep. ",
        "taste": "The ambient air carries with it the lingering taste of the night's feast, a melange of savory and sweet that indulges the palate like the memory of a joyous celebration.",
    },
    (0, 3): {
        ...
        "smell": "The kitchen is awash with the tantalizing scents of baking bread, roasting meat, and the fragrant whisper of herbs freshly plucked from the garden.",
        "sound": "A cacophony of clattering pans, crackling fires, and the steady, comforting drone of voices in collaboration create an ever-present soundtrack to this culinary realm. ",
        "taste": "The very air is rich with the essence of savory stocks and sweet confections, leaving a hint of salt and sugar upon the tongue, a foretaste of delights to come.",
    },
    ("*", "*"): {},
    ("*", "*", "*"): {},
}
...
PROTOTYPES_FLOOR1 = {
    (3, 2): {
        ...
        "smell": "The fragrance of polished marble mixed with the subtle, comforting scent of beeswax from elaborate candles filling lanterns scattered throughout the hall.",
        "sound": "The grand lobby resonates with the soft hum of whispered conversations and the distant, muffled footsteps on stone, rich with the echoes of grandeur.",
        "taste": "The air carries a faint whisper of earthy richness, reminiscent of ancient tomes and traveled paths, teasing the senses with the essence of exploration captured on the map table.",
        "details": {
            "statues": "The statues stand with an imposing elegance, their alabaster forms exuding a profound peace. Each figure exemplifies the pinnacle of virtuous leadership, captured in mid-thought or poised with a philosopher's gaze, their presence commanding yet benevolent.",
            "table": "The table is a masterpiece of craftsmanship, the golden oak's radiant grain encircling an intricately inlaid map. It spans continents and oceans with delicate artistry, ornate compass roses and legendary creatures adorning its corners, inviting all to ponder the expanses of the world they inhabit.",
        },
    },
    (5, 2): {
        ...
        "smell": "The subtle scent of beeswax lingers in harmony with the aging oak and a faint draft of the bracing, fresh air from the nearby gardens.",
        "sound": "The soft echo of one's own footsteps partners with the distant, muffled calls of heralds and the occasional creak of a gently-swinging door.",
        "taste": "The perceived taste is one of antique elegance, a whisper of spiced pears served in distant halls, carrying the hint of bygone feast days.",
    },
    (6, 2): {
    ...
    (0, 2): {
        ...
        "smell": "A delicate fragrance of lavender and rosewood permeates the air, interwoven with the faint, comforting scent of burning oak from the hearth.",
        "sound": "The soft rustling of silk drapes, swaying gently with the breath of the night air, mingles with the distant murmur of the castle's lifeblood, kept at bay by thick stone walls.",
        "taste": "The air carries the regal essence of aged wine and honeyed fruits, reminiscent of banquets held in honor of kings and queens of yore.",
        "details": {
            "bed": "The bed, a masterpiece of craftsmanship, is festooned with sumptuous fabrics: a duvet imbued with the softest down of geese, and pillows plump as cloud banks in a summer sky, encased in linens the color of fresh cream. Heavy damask curtains, deep burgundy in hue, can be drawn to shroud the room in opulent darkness, or parted to reveal the verdant sweep of the royal gardens beyond."
        },
    },
    (2, 1): {
        ...
        "smell": "The perfume of the great hall rises to meet the fresh scent of flora—a mingling of old stone, polished wood, and a tapestry of banquet delicacies.",
        "sound": "From below, the symphony of communal life crescendos—a constellation of conversations, laughter, and the soft, rhythmic steps of those who dance to the tune of royalty.",
        "taste": "There exists an ambience of aerial grace, imbued with the subtle taste of the crisp, outside air that mixes with the sweet essence of garnished dishes from feasts laid out beneath.",
    },
    (3, 1): {
        "key": "Castle Valaria - Balcony",
        "desc": "Suspended between the majestic western and eastern wings of the castle, the balcony is as if suspended in a daydream, which allows for a commanding view of the vast great hall below. Encased by an intricately wrought balustrade of goldenrod hue, it boasts a filigree of ironwork so fine, the delicate pattern seems spun by mythical weaver spiders from tales of yore. Here, one can lean upon the cool metal, while gazing out over the ebb and flow of courtly ceremony below, the balcony a privileged perch from which to observe the intricacies of high society weave through the grand dance of life. The stone underfoot, worn smooth by the presence of countless royal soles, glistens with a patina earned through ages of vigilant observation. <evening>|/|/    As dusk embraces the sky, the balcony becomes a stage for the ballet of twilight, where the heavy velvet of night drapes over the firmament, and the stars emerge as a scattering of |#dcdcdcsilver|n dust across the theater of the heavens.</evening>",
